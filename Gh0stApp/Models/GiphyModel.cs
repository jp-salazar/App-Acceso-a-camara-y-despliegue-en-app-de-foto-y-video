...
{
    public partial class GiphyModel
    {
        [JsonProperty("data")]
    ...
    public partial class GiphyModel
    {
        public static GiphyModel FromJson(string json) => JsonConvert.DeserializeObject<GiphyModel>(json, Gh0stApp.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GiphyModel self) => JsonConvert.SerializeObject(self, Gh0stApp.Models.Converter.Settings);
    }
